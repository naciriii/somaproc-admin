...
<div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Tabs <a href="{{ url('/tab/add') }}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Create New Tab</a></h2>
                        ...
                        <tbody>
                            @if(count($tabs))
								...
								<tr>
									...
									<td>{{$row->link_tag}}</td>
									<td>
										<a href="{{ url('/tab/edit') }}/{{$row->id}}" class="btn btn-info btn-xs"><i class="fa fa-pencil" title="Edit"></i> </a>
...
<script>
	function delete_item(id){
        $('#myModal').modal('show');
        $('#confirm_delete_button').attr('href',"{{ url('/tab/delete') }}/"+id);
	}
</script>
