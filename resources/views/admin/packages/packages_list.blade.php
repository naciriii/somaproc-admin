...
<div class="">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Packages <a href="{{ url('/package/add') }}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Create New Package</a></h2>
                        ...
                        <tbody>
                            @if(count($packages))
								...
								<tr>
									...
									<td>
										<a href="{{ url('/package/edit') }}/{{$row->id}}" class="btn btn-info btn-xs"><i class="fa fa-pencil" title="Edit"></i> </a>
...
<script>
	function delete_item(id){
        $('#myModal').modal('show');
        $('#confirm_delete_button').attr('href',"{{ url('/package/delete') }}/"+id);
	}
</script>
